fun main() {
    ...
    fun part2(input: List<String>) : Long {
        ...
        return acceptedValueRanges.toList().sumOf { range ->
            range.toList().fold(1L) { acc, ent ->
                acc * ent.map { it }.size
            }
        }
    }
...
private fun XmasRange.getScore() : Long = (this.x.last-this.x.first) * (this.m.last - this.m.first) * (this.a.last - this.a.first) * (this.s.last - this.s.first)
